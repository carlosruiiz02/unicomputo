...
<div class="card shadow p-4" style="max-width: 480px; width: 100%;">
    <h3 class="text-center fw-semibold mb-3">Editar producto</h3>
    <p class="text-center text-subtitle mb-4">Modifica los datos del producto seleccionado.</p>
    ...
    <form method="POST" action="{{ route('productos.update', $producto['codigo']) }}">
        ...
        <input type="text" name="categoria" class="form-control mb-4" value="{{ $producto['categoria'] }}" required>
